document.addEventListener("DOMContentLoaded", async () => {
    const container = document.querySelector('.homelastRender1'); // Select the container where the products will be rendered

    try {
        // Fetch most viewed products from the API
        const response = await fetch('https://grocer.softwaresystems.us/api/v1/products/most-viewed');
